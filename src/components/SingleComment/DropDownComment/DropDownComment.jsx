...
export default function DropDownComment({postId,commentId}) {
...
function createComment(values) {
  ...
  return (
    <>
      ...
      <Button aria-label="Menu" className="bg-transparent">
       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="oklch(0.6204 0.195 253.83)" className="size-6">
      ...
      <Dropdown.Popover>
        <Dropdown.Menu onAction={(key) => key === "edit-file"? setmodalOpen(true):""}>
          <Dropdown.Item id="edit-file" textValue="Edit file">
            <Button className="bg-transparent text-gray-800 p-0">Edit Comment</Button>
          </Dropdown.Item>
          <Dropdown.Item id="delete-file" textValue="Delete file" variant="danger">
            <div onClick={delComment} className="text-red-500" >Delete file</div>
          </Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown.Popover>
    </Dropdown>
  ...
  <div className="flex items-center gap-2 rounded-2xl border border-gray-200 bg-white p-2 my-7 focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500 transition-all">
    ...
    <div className="flex items-center">
      ...
      <input id="commentImage" {...register("image")}   type="file"   className="hidden" />
    </div>
